import { PaymentsGetPaymentRefundImage } from "@/assets";
...
const areas =  [
  {
    ...
    alt: "",
    title: "",
    href: "https://api.truelayer-sandbox.com/v3/payments/%7Bpayment_id%7D/refunds/%7Brefund_id%7D",
...
const PaymentsGetPaymentRefundPage = () => {
  return (
    <CommonImgMapPage
      pageTitle={`Get payment refund`}
      image={PaymentsGetPaymentRefundImage}
...
export default PaymentsGetPaymentRefundPage;
