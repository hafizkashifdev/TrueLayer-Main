...
const cardsData = [
  ...
  { key: '2', title: 'Get merchant account', href: '/get-merchant-account-main', icon: MerchantAccountsImage2 },
  { key: '3', title: 'Get transactions', href: '/get-transactions', icon: MerchantAccountsImage3 },
  ...
  { key: '7', title: 'Get payment sources', href: '/get-payment-sources', icon: MerchantAccountsImage7 },
